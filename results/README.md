...
| [`phase1_fictional_framing_balanced.md`](phase1_fictional_framing_balanced.md) | **Phase 1.5-B — balanced fictional-framing re-extraction.** N=30 training + 15 held-out adversarial_jailbreak. cos(d̂_old, d̂_augmented) = 0.9938; held-out test prompts don't move onto axis (mean rise +0.027 of natural scale). Closes the open-loop prediction from `phase1_step3c_*`; fictional-framing reads as a separable mechanism from AdvBench-style refusal under statistical extraction. |
