...
| [`phase1_subspace_ablation.md`](phase1_subspace_ablation.md) | **The methodology contribution.** Bootstrap LDA cells + L3 d_hat ablation test. Only L13 diff-of-means is causal; five orthogonal classification-equivalent directions are all inert. Explicit statistical-vs-gradient extraction decoupling. |
