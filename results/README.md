...
| [`phase1_fictional_framing_balanced.md`](phase1_fictional_framing_balanced.md) | **Phase 1.5-B extraction half — balanced fictional-framing re-extraction.** N=30 training + 15 held-out adversarial_jailbreak. cos(d̂_old, d̂_augmented) = 0.9938; held-out test prompts don't move onto axis (mean rise +0.027 of natural scale). |
| [`phase1_fictional_framing_causal.md`](phase1_fictional_framing_causal.md) | **Phase 1.5-B causal half — does ablation actually stop refusal?** Ablating d̂ drops fictional-framing refusal 14/15 → 2/15 (Haiku 4.5 judge), including 2 of 3 prompts that projected below d̂'s midpoint. Flips the extraction-half reading: d̂'s linear classifier covers ~80% of these prompts, its causal mechanism reaches ~93%. Classification ≠ causation at the prompt level. |
